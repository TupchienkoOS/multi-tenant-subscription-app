            ...
            <ul className="nav metismenu" id="side-menu">
              ...
              <li className="active">
                <a href="#">
                  ...
                  <span className="float-right label label-primary">
                    SPECIAL
                  </span>
                </a>
              ...
              <li>
                ...
                <ul className="nav nav-second-level collapse">
                  <li>
                    <a href="toast_notifications.html">Notification</a>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul className="nav nav-second-level collapse">
                  ...
                  <li>
                    <a href="helper_classNamees.html">Helper css classNamees</a>
                  </li>
                  <li>
                    ...
                    <li>
                      <div className="dropdown-messages-box">
                        ...
                        <div className="media-body ">
                          ...
                          following <strong>Monica Smith</strong>. <br></br>
                          <small className="text-muted">
                ...
                <div className="ibox ">
                  ...
                  <div>
                    ...
                    <div className="ibox-content profile-content">
                      ...
                      <p>
                        <i className="fa fa-map-marker"></i> Riviera State
                        32/106
                      </p>
                      <h5>About me</h5>
                      <p>
