            ...
            <li className="dropdown">
                ...
                <ul className="dropdown-menu dropdown-messages">
                    <li>
                        <div className="dropdown-messages-box">
                            <a className="dropdown-item float-left" href="profile.html">
                                <img alt="image" className="rounded-circle" src="img/a7.jpg"></img>
                            </a>
                    ...
                    <li>
                        <div className="dropdown-messages-box">
                            <a className="dropdown-item float-left" href="profile.html">
                                <img alt="image" className="rounded-circle" src="img/a4.jpg"></img>
                            </a>
                            <div className="media-body ">
                    ...
                    <li>
                        <div className="dropdown-messages-box">
                            <a className="dropdown-item float-left" href="profile.html">
                                <img alt="image" className="rounded-circle" src="img/profile.jpg"></img>
                            </a>
                            <div className="media-body ">
                ...
                <div className="ibox ">
                    ...
                    <div>
                        <div className="ibox-content no-padding border-left-right">
                            <img alt="image" className="img-fluid" src="img/profile_big.jpg"></img>
                        </div>
                            ...
                            <div className="feed-activity-list">
                                ...
                                <div className="feed-element">
                                    <a href="#" className="float-left">
                                        <img alt="image" className="rounded-circle" src="img/a1.jpg"></img>
                                    </a>
                                    <div className="media-body ">
                                        <small className="float-right text-navy">1m ago</small>
                                        <strong>Sandra Momot</strong> started following <strong>Monica Smith</strong>. <br></br>
                                        ...
                                        <div className="actions">
                                            ...
                                            <a href="" className="btn btn-xs btn-danger"><i className="fa fa-heart"></i> Love</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="feed-element">
                                    <a href="#" className="float-left">
                                        <img alt="image" className="rounded-circle" src="img/a2.jpg"></img>
                                    </a>
                                    <div className="media-body ">
                                        <small className="float-right">2h ago</small>
                                        <strong>Mark Johnson</strong> posted message on <strong>Monica Smith</strong> site. <br></br>
                                        ...
                                        <div className="float-right">
                                            ...
                                            <a href="" className="btn btn-xs btn-primary"><i className="fa fa-pencil"></i> Message</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="feed-element">
                                    <a href="#" className="float-left">
                                        <img alt="image" className="rounded-circle" src="img/a3.jpg"></img>
                                    </a>
                                    <div className="media-body ">
                                        <small className="float-right">2h ago</small>
                                        <strong>Janet Rosowski</strong> add 1 photo on <strong>Monica Smith</strong>. <br></br>
                                        <small className="text-muted">2 days ago at 8:30am</small>
                                        <div className="photos">
                                            <a target="_blank" href="http://24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg"> <img alt="image" className="feed-photo" src="img/p1.jpg"></img></a>
                                            <a target="_blank" href="http://37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg"> <img alt="image" className="feed-photo" src="img/p3.jpg"></img></a>
                                            </div>
                                    </div>
                                </div>
                                <div className="feed-element">
                                ...
                                <div className="feed-element">
                                    <a href="#" className="float-left">
                                        <img alt="image" className="rounded-circle" src="img/a5.jpg"></img>
                                    </a>
                                    <div className="media-body ">
                                        <small className="float-right">2h ago</small>
                                        <strong>Kim Smith</strong> posted message on <strong>Monica Smith</strong> site. <br></br>
